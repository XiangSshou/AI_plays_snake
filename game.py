...
if __name__ == "__main__":
    ...
    if not args['vsAI']:
        ...
        for i in range(len(snakes)-1):
            text = 'Generation : '+str(generation+1)+' vs '+str(generation+2)
            pygame.display.set_caption(text)
            print('---- Snake[1]: Generation:', generation+1,' vs  Snake[2]: Generation:', generation+2,'----')
            ...
            t_snake2 = snake(width, height, brainLayer, block_length, head_x=width-60, head_y=height-60,
                            random_weights=False, random_bases=False)
        ...
        while True:
            ...
            pygame.display.set_caption(text)
            seed = random.random()
            t_snake = snake(width, height, brainLayer, block_length, head_x=width-60, head_y=height-60,
                            random_weights=False, random_bases=False)
